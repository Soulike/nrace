...
class FunctionBuilder {
    ...
    store (hbFileName) {
        let contextInfoFileName = hbFileName.replace('.newhb-full.json', '.context.json')
        ...
        let contextChainFileName = hbFileName.replace('.newhb-full.json', '.context-chain.json')
        ...
        let dycontextChainFileName = hbFileName.replace('.newhb-full.json', '.dyContext-chain.json')
